...
puts("bind done");
	...
	read_size=recv(client_sock,client_status,3000,0);

	
if(strcmp(client_status,"single")==0){
	...
	server1.sin_addr.s_addr=inet_addr("192.168.13.128");
	...
	if(send(serversocket1,client_status,strlen(client_status),0)<0){
	...
	else if(strcmp(client_status,"married")==0){
	...
	server2.sin_addr.s_addr=inet_addr("192.168.13.131");
	...
	if(send(serversocket2,client_status,strlen(client_status),0)<0){
